...
print("-----------------")
print("Sort by season:")
sort_season_list = fishingManager.sort_fishing_list_by_season(True)
print(*sort_season_list, sep="\n")
print("-----------------")
print("Search by price:")
search_list = fishingManager.search_by_price(1000)
print(*search_list, sep="\n")
print("-----------------")
print("Search by season:")
season_list = fishingManager.search_by_season(Season.SUMMER)
print(*season_list, sep="\n")
